...
Config = {
	...
	WebhookSetJob = "",
	WebhookItems = "",
	WebhookDeadLogs = "https://discord.com/api/webhooks/1179979596414857226/GBr-WNvrWcsE9T__qZ_Tf1HjM17GCvMWp0Xo4V6m9XmEslesnE5D38wtCUwVpBHrIuyY",
	WebhookDuty = "",
	WebhookStash = "",
	WebhookSearch = "",
	WebhookMoney = "",
	----------------------------------------------------------------------------------------------------------------------------
	Registry = true, -- If you have SS-Registry set it true !
	PoliceMission = true, -- If you have SS-PoliceMissions set it true !
	Archives = true, -- If you have SS-Archives set it true !
	Lockpick = true, -- If you have SS-Lockpick set it true (open the prison wagon as a player and use lockpick if a player nearby is handcuffed)
	BankHeist = true, -- If you have SS-BankHeist set it true (To receive alerts when a bank heist start!)
	Bank = true, -- If you have SS-Bank you can have money account for every section !
	ClothingScript = true, -- If you have any clothing script you can change your clothes in the menu !
	RemoveDeadHandcuffed = true, -- true if you want to remove Handcuffs when die
	SSMetabolism = true, -- If you have SS-Metabolism, you can set to remove rep and add stress when kill someone !
	...
	PaymentTime = 180, -- 1800 seconds (30 minutes)
